####################################################################
# Program Name :      Platform Surveillance System
# Description :       This application periodically monitors system
#                      resources like CPU, RAM, Disk, Network and
#                      running processes and stores the report into
#                      log files automatically.
#  Input :             Time interval (minutes), Directory name
#  Output :            Log file containing system information
...
#                      such as CPU, RAM, Disk, Network and processes
# Input :             FolderName (string)
# Output :            Log file created in specified directory
####################################################################
...
# Description :     Collects information of all running processes
# Input :           None
# Output :          List of process information dictionaries
####################################################################
...
#                  arguments and schedules periodic execution
####################################################################
